...
function site_scripts() {
    ...
    if (is_page_template('archive-edusource.php')) {
        wp_enqueue_script( 'lernstoff-js', get_template_directory_uri() . '/dist/assets/js/lernstoff.js', array( 'jquery', 'isotope-js', 'imagesloaded-js', 'select2-js' ), '', true );
    }
