...
function register_acf_block_types() {
    ...
    acf_register_block_type(['name' => 'wlo_redaktion_new_content',
    ...
    acf_register_block_type(['name' => 'wlo_redaktion_check_new_content',
    ...
    acf_register_block_type(['name' => 'wlo_redaktion_metaqs',
