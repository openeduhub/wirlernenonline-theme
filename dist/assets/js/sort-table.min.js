...
function sortTable(a, b, c) {
  ...
  for (c = 0; c < a.tHead.rows[a.tHead.rows.length - 1].cells.length; c++) {
    b == a.tHead.rows[a.tHead.rows.length - 1].cells[c].getAttribute("data-js-sort-colNum") && (d = a.tHead.rows[a.tHead.rows.length - 1].cells[c].className.match(/js-sort-[-\w]+/));
  }
  ...
  for ("none" != sortTable.sortFunc && b.sort(sortTable.compareRow); a.firstChild;) {
...
sortTable.input = function (a) {
  for (var b = 0; b < a.children.length; b++) {
    if ("object" == _typeof(a.children[b]) && "undefined" != typeof a.children[b].value) return a.children[b].value.toLowerCase();
  }
...
sortTable.init = function () {
  ...
  c = c.sheet;
  c.insertRule('table.js-sort-asc thead tr > .js-sort-active:not(.js-sort-none):after {content: "\\25b2";font-size: 0.7em;padding-left: 3px;line-height: 0.7em;}', 0);
