<div class="grid-container">
  <div class="grid-x grid-margin-x">
    <div class="cell auto">
      ...
      <h1 class="margin-bottom-2"><img src="<?php echo get_template_directory_uri(); ?>/src/assets/img/lehrer-icon-150x150.png" width="50" alt="Lehrer*innen"> Neues für Lehrer*innen</h1>
    </div>
